...
// Full asset path is preserved so the local file matches the URL the renderer builds
// (assetBase + 'Assets/CompositeDoors/Images/...'). A stripped path would 404 in the plugin.
assert.match(plan[0].localPath, /assets\/img\/endurance\/Assets\/CompositeDoors\/Images\/DoorBlanks\/Door Mould 10\/Thumbnails\/White\.jpg$/);
